defmodule Benchee.Formatters.CSV do
  ...
  @column_descriptors ["Name", "Iterations per Second", "Average",
                       "Standard Deviation", "Standard Deviation Ratio",
                       "Median"]
  ...
  defp to_csv({name, %{ips:           ips,
                       ...
                       median:        median}}) do
    [name, ips, average, std_dev, std_dev_ratio, median]
  end
end
